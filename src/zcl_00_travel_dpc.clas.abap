class ZCL_00_TRAVEL_DPC definition
  public
...
protected section.
  ...
  methods Z00_C_TRAVELTP_CREATE_ENTITY
    importing
    ...
    exporting
      !ER_ENTITY type ZCL_00_TRAVEL_MPC=>TS_Z00_C_TRAVELTPTYPE
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  methods Z00_C_TRAVELTP_DELETE_ENTITY
    importing
      !IV_ENTITY_NAME type STRING
      !IV_ENTITY_SET_NAME type STRING
      !IV_SOURCE_NAME type STRING
    ...
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  methods Z00_C_TRAVELTP_GET_ENTITY
    importing
      !IV_ENTITY_NAME type STRING
      !IV_ENTITY_SET_NAME type STRING
      !IV_SOURCE_NAME type STRING
    ...
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  methods Z00_C_TRAVELTP_GET_ENTITYSET
    importing
      !IV_ENTITY_NAME type STRING
      !IV_ENTITY_SET_NAME type STRING
      !IV_SOURCE_NAME type STRING
    ...
    exporting
      !ET_ENTITYSET type ZCL_00_TRAVEL_MPC=>TT_Z00_C_TRAVELTPTYPE
      !ES_RESPONSE_CONTEXT type /IWBEP/IF_MGW_APPL_SRV_RUNTIME=>TY_S_MGW_RESPONSE_CONTEXT
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  methods Z00_C_TRAVELTP_UPDATE_ENTITY
    importing
      !IV_ENTITY_NAME type STRING
      !IV_ENTITY_SET_NAME type STRING
      !IV_SOURCE_NAME type STRING
...
CLASS ZCL_00_TRAVEL_DPC IMPLEMENTATION.
...
*&* This class has been generated on 28.01.2021 10:08:42 in client 100
*&*
*&*       WARNING--> NEVER MODIFY THIS CLASS <--WARNING
*&*   If you want to change the DPC implementation, use the
*&*   generated methods inside the DPC provider subclass - ZCL_00_TRAVEL_DPC_EXT
*&-----------------------------------------------------------------------------------------------*

 DATA z00_c_traveltp_create_entity TYPE zcl_00_travel_mpc=>ts_z00_c_traveltptype.
...
*-------------------------------------------------------------------------*
*             EntitySet -  Z00_C_TravelTP
*-------------------------------------------------------------------------*
     WHEN 'Z00_C_TravelTP'.
*     Call the entity set generated method
    z00_c_traveltp_create_entity(
         EXPORTING iv_entity_name     = iv_entity_name
       	 ...
       	 IMPORTING er_entity          = z00_c_traveltp_create_entity
    ).
*     Send specific entity data to the caller interfaces
    copy_data_to_ref(
      EXPORTING
        is_data = z00_c_traveltp_create_entity
      CHANGING
        cr_data = er_entity
   ).
...
*&-----------------------------------------------------------------------------------------------*
 ...
 DATA z00_c_traveltp_get_entity TYPE zcl_00_travel_mpc=>ts_z00_c_traveltptype.
 DATA lv_entityset_name TYPE string.
...
*     Call the entity set generated method
          z00_c_traveltp_get_entity(
               EXPORTING iv_entity_name     = iv_entity_name
                         ...
                         it_navigation_path = it_navigation_path
                         io_tech_request_context = io_tech_request_context
             	 IMPORTING er_entity          = z00_c_traveltp_get_entity
                         es_response_context = es_response_context
          ).

        IF z00_c_traveltp_get_entity IS NOT INITIAL.
*     Send specific entity data to the caller interface
          copy_data_to_ref(
            EXPORTING
              is_data = z00_c_traveltp_get_entity
            CHANGING
              cr_data = er_entity
          ).
        ELSE.
...
*&*   generated methods inside the DPC provider subclass - ZCL_00_TRAVEL_DPC_EXT
*&-----------------------------------------------------------------------------------------------*
 DATA z00_c_traveltp_get_entityset TYPE zcl_00_travel_mpc=>tt_z00_c_traveltptype.
 DATA lv_entityset_name TYPE string.
...
*     Call the entity set generated method
      z00_c_traveltp_get_entityset(
        EXPORTING
         ...
         io_tech_request_context = io_tech_request_context
       IMPORTING
         et_entityset = z00_c_traveltp_get_entityset
         es_response_context = es_response_context
       ).
*     Send specific entity data to the caller interface
      copy_data_to_ref(
        EXPORTING
          is_data = z00_c_traveltp_get_entityset
        CHANGING
...
*&-----------------------------------------------------------------------------------------------*
 ...
 DATA z00_c_traveltp_update_entity TYPE zcl_00_travel_mpc=>ts_z00_c_traveltptype.
 DATA lv_entityset_name TYPE string.
 DATA lr_entity TYPE REF TO data. "#EC NEEDED
...
*     Call the entity set generated method
          z00_c_traveltp_update_entity(
               EXPORTING iv_entity_name     = iv_entity_name
                         ...
                         it_navigation_path = it_navigation_path
                         io_tech_request_context = io_tech_request_context
             	 IMPORTING er_entity          = z00_c_traveltp_update_entity
          ).
       IF z00_c_traveltp_update_entity IS NOT INITIAL.
*     Send specific entity data to the caller interface
          copy_data_to_ref(
            EXPORTING
              is_data = z00_c_traveltp_update_entity
            CHANGING
              cr_data = er_entity
          ).
        ELSE.
...
* Unit test injection
  ...
  method IF_SADL_GW_DPC_UTIL~GET_DPC.
    TYPES ty_z00_c_traveltp_1 TYPE z00_c_traveltp ##NEEDED. " reference for where-used list
    ...
    ro_dpc = cl_sadl_gw_dpc_factory=>create_for_sadl( iv_sadl_xml   = lv_sadl_xml
               iv_timestamp         = 20210128100841
               iv_uuid              = 'Z00_TRAVEL'
               io_context           = me->mo_context ).
  endmethod.


  method Z00_C_TRAVELTP_CREATE_ENTITY.
  ...
  method Z00_C_TRAVELTP_UPDATE_ENTITY.
